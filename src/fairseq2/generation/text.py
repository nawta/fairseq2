...
class TextTranslator:
    ...
    def batch_translate(
        ...
        source_seqs, source_seqs_layout = pad_seqs(source_seq_list, self._pad_idx)
...
class TextCompleter:
    ...
    def batch_complete(
        ...
        prompt_seqs, prompt_seqs_layout = pad_seqs(prompt_seq_list)

        return self._do_complete(prompt_seqs, prompt_seqs_layout)
